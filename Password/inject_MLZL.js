...
function config_目录治理(url) {
	...
	initTableCss_目录治理();
	let pwds = [
		{title: '数据局（编制）', name: 'daxqzsj', pwd: 'Admin@123456', 'lxr': ''},
		// {title: '数据局（系统目录审核）', name: 'daxqzsjxtshy', pwd: 'Admin@1234', 'lxr': ''},
		// {title: '数据局（职责目录审核、数据目录审核、三清单审核）', name: 'daxqzsjmlshy', pwd: 'Admin@1234', 'lxr': ''},
		
		{title:'生态环境局', name:'jjsdasthjj', pwd:'Dean@4667668ss', 'lxr': '李昱炜'},
		{title: '科工局', name: 'daxkxjshgyxxhj', pwd: 'Aa46665060@s', 'lxr': '曾令贵'},
		{title:'市场监督管理局', name:'daxscjdglj', pwd:'Dasjj@4667701s', 'lxr': '闵敏'},
		{title:'---药监局', name:'德安市监药品、医疗器械与化妆品监督管理股', pwd:'Sjj123456*', 'lxr': '闵敏'},
		{title:'农业农村局', name:'daxnyncj', pwd:'Daxnyncj@4332930s', 'lxr': '胡超'},
		{title:'自然资源局', name:'daxzrzyj', pwd:'Da123456@s', 'lxr': '钟天乾'},
		{title:'财政局', name:'daxczgz', pwd:'Admin@12345', 'lxr': ''},
		{title:'--国有资产监督管理委员会', name:'daxgyzcjdglwyh', pwd:'Admin@12345', 'lxr': '蔡孝荣'},
		{title:'金融监管局', name:'gjjrjdglzjjjsfjdaxzj', pwd:'Admin@12345s', 'lxr': '郝能全 / <b>吴彬</b>(183 7011 0029)'},
		...
		{title:'消防救援大队', name:'daxxfjydd', pwd:'Daxf@2025s', 'lxr': '彭小蜜'},
		
		{title:'', name:'', pwd:'', 'lxr': ''},
		{title:'编办', name:'zgjjsdaxwjgbzwyhbgs', pwd:'Bb@4332938s', 'lxr': '易春宾'},
	];
